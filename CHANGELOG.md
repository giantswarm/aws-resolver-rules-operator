...
- Support using static credentials instead of relying on IRSA to authenticate to AWS. IRSA created a chicken-egg problem since we use Crossplane to create IRSA resources.

...
func (r *DnsReconciler) getBastionIp(ctx context.Context, cluster *capi.Cluster) (string, error) {
	...
	if cluster.Annotations[gsannotations.AWSVPCMode] == gsannotations.AWSVPCModePrivate {
